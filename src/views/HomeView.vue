...
.screen-center {
  @apply h-[95vh] flex flex-col items-center justify-center text-center gap-4;
}

.slogan {
  @apply text-stone-400 font-semibold text-3xl sm:text-5xl md:font-medium md:text-6xl;
}
